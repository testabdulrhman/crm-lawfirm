...
const DEFAULT_REJECTION =
  'مرحباً {name}، نشكر تقديمكم على الوظيفة لدى شركة عبدالرحمن بن رضوان المشيقح للمحاماة وإدارة إجراءات الإفلاس. نعتذر عن عدم قبول طلبكم حالياً، ونتمنّى لكم التوفيق.'
