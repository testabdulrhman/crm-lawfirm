...
// تبويب «الملفات» الموحّد (نموذج Matter — قرار المستخدم 2026-08-21):
// «ليه ما يكون تبويب واحد وكل مشروع له نموذج على حسب نوعه؟» — واعتمد
// التسمية «الملفات» (لغة المهنة: «افتح ملف»، «وين الملف؟»).
//
